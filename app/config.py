...
settings = Settings(
    ...
    app_version=os.getenv('KV_APP_VERSION', '48.0.0'),
    app_version_label=os.getenv('KV_APP_VERSION_LABEL', 'v48'),
    base_dir=BASE_DIR,
    ...
    max_upload_size_mb=max(1, _env_int('KV_MAX_UPLOAD_MB', 25, minimum=1, maximum=250)),
