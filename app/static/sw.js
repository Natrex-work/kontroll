const CACHE = 'kv-kontroll-v60-offline-new-cases';
const STATIC_PREFIX = '/static/';
const API_CACHE_PREFIXES = ['/api/map/catalog', '/api/map/bundle', '/api/map/features', '/api/map/identify', '/api/zones/check', '/api/rules'];
const ASSETS = [
  '/dashboard',
  '/kontroller',
  '/kart',
