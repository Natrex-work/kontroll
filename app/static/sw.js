const CACHE = 'kv-kontroll-v86-map-offline';
const MAP_TILE_CACHE = 'kv-kontroll-v86-map-tiles';
...
const ASSETS = [
  ...
  '/regelverk',
  '/cases/offline/new',
  '/static/styles.css?v=v86',
  '/static/js/local-media.js',
  '/static/js/local-cases.js',
  '/static/js/local-map.js',
  '/static/js/common.js?v=v86',
  '/static/js/case-app.js?v=v86',
