const CACHE = 'kv-kontroll-v87-map-offline';
const MAP_TILE_CACHE = 'kv-kontroll-v87-map-tiles';
...
const ASSETS = [
  ...
  '/regelverk',
  '/cases/offline/new',
  '/static/styles.css?v=v87',
  '/static/js/local-media.js',
  '/static/js/local-cases.js',
  '/static/js/local-map.js',
  '/static/js/common.js?v=v87',
  '/static/js/case-app.js?v=v87',
