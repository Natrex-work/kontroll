(function () {
  ...
  if ('serviceWorker' in navigator) {
    window.addEventListener('load', function () {
      navigator.serviceWorker.register('/static/sw.js?v=1.8.29').catch(function () {});
    });
  }
  ...
  var LAYER_PANEL_PREFS_VERSION = '1.8.29';
  ...
  function createPortalMap(el, layers, markerState) {
    ...
    function layerServiceMeta(layer, fisheryServiceUrl, vernServiceUrl) {
      ...
      // 1.8.29: Ikke send Yggdrasil-lag til Fiskeridir_vern bare fordi de
