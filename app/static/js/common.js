    ...
    if (!shouldFetchFeatureDetails) {
      ...
      var tasks = (layers || []).map(function (layer) {
        return function () {
          ...
          var directUrl = mapServerUrl ? directMapFeatureUrl(mapServerUrl, layer.id, bbox) : '';
          return fetchPortalFeatureCollection(viewKey, url, directUrl)
            .then(function (data) {
      ...
      featurePromise = runLimited(tasks, PORTAL_FETCH_CONCURRENCY);
    }
