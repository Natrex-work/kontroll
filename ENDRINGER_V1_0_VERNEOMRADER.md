# V1.0 versjonering og verneområder

- Endret intern og synlig versjonering fra v101/101.0.0 til V1.0/1.0.0.
- Oppdatert cache-bust-parametre, service worker-navn og kart-/temalag-cache til V1.0/v1-0 slik at ny JS/CSS skal lastes etter deploy.
