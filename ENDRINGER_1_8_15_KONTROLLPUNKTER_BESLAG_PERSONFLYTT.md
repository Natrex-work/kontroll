# 1.8.15 - Kontrollpunktbeslag og flyttet Person/fartoy
...
- Versjon/cache er bumpet til 1.8.15. Service worker bruker nytt cache-navn, nye asset-URLer, og `/api/rules` samt `/api/zones/check` hentes nettverksdirekte for aa unngaa stale kontrollpunkt- og posisjonsdata.
