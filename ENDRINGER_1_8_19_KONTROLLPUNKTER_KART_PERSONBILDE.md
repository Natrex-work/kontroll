# Endringer 1.8.19 - kontrollpunkter, kart og person/fartoy bildeanalyse
...
- Temalag-preferanser er bumpet til ny versjon slik at gamle skjulte lag fra 1.8.18 ikke skjuler nye lag i 1.8.19.
...
- Appversjon bumpet til 1.8.19.
- Service worker-cache bumpet til kv-kontroll-1-8-19-static og kv-kontroll-1-8-19-map-tiles.
- JS/CSS lastes med ?v=1.8.19.
