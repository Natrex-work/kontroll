...
def recommend_area_violation(area_status: str = '', area_name: str = '', species: str = '', gear_type: str = '', notes: str = '') -> dict[str, Any] | None:
    ...
    if 'fredningsområde' in status_n and ('hummer' in _norm(area_name) or species_n == 'hummer'):
        ...
        if gear_n and gear_n not in ALLOWED_GEARS_HUMMER_FREDNING:
            item['status'] = 'avvik'
            item['notes'] = f'Posisjonen ligger i {area_name or "hummerfredningsområde"}. Valgt redskap ({gear_type}) er ikke blant redskapene som er tillatt i området.'
            message = f'Mulig lovbrudd: {gear_type or "redskap"} i hummerfredningsområde.'
        else:
            item['status'] = 'ikke kontrollert'
            item['notes'] = f'Posisjonen ligger i {area_name or "hummerfredningsområde"}. Kontroller at valgt redskap er tillatt i området.'
    ...
    if 'stengt område' in status_n or 'nullfiske' in status_n:
        ...
        item['notes'] = f'Posisjonen ligger i {area_name or area_status}. Valgt redskap ({gear_type or "ukjent redskap"}) må vurderes som ulovlig eller særskilt regulert i området.'
        if notes:
            item['notes'] += f' Kartgrunnlag: {notes}'
    ...
    if 'maksimalmål område' in status_n and species_n == 'hummer':
        ...
        item['notes'] = f'Posisjonen ligger i {area_name or area_status}. Kontroller maksimalmål i tillegg til øvrige hummerregler.'
    ...
    if 'regulert område' in status_n:
        ...
        item['notes'] = f'Posisjonen ligger i {area_name or area_status}. Kontroller områdets særregler for valgt art og redskap.'
    ...
    if 'fredningsområde' in status_n:
        ...
        item['notes'] = f'Posisjonen ligger i {area_name or area_status}. Kontroller om valgt art og redskap er tillatt.'
